...
export const translations = {
  ...
  zh: {
    ...
    hero: {
      ...
      description:
        '15 年技术老兵，一路从中国互联网黄金期（美团点评、满帮集团）走到 Dell Technologies 做企业级分布式存储。近几年一头扎进 AI Agent 领域：从零搭建了一个 87 技能的自主 Agent 平台，打通 10 多个内部系统，带向量记忆和智能路由，团队 200 多人在用。也做过自驱动测试 Agent、多模型编排，拿过 VP 年度之星和公司黑客松冠军。',
      cta: '看看我做了什么',
    },
    skills: {
      title: '技能树',
